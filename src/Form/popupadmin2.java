...
public class popupadmin2 extends javax.swing.JFrame {
    ...
    try {
    String sql = "Select * from admin where id like '%"+cariitem+"%' or nama_admin like '%"+cariitem+"%' order by id asc";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Admin", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 14))); // NOI18N
    ...
    private void tbladminMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbladminMouseClicked
        int tabelAdmin = tbladmin.getSelectedRow();
        FP.id_admin = tbladmin.getValueAt(tabelAdmin, 0).toString();
        FP.itemTerpilih1();
        this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popupadmin2().setVisible(true);
            }
        });
    }
